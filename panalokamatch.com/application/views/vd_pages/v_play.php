...
$this->load->view('v_head',$view_data) ;
?>
<!-- ======== END Head ============ -->
			   ...
			   <ul>
				<li class="green">
					...
					<ul>
					    ...
					    <li><a href="<?php echo base_url().'Gate/'?>register">Register</a></li>
		        ...
		        <ul class="nav navbar-nav nav_1">
		    		...
		    		<li class="dropdown">
		              ...
		              <ul class="dropdown-menu" role="menu">
		                <li><a href="<?php echo base_url('Member/matches') // matches.html ?>">New Matches</a></li>
		                <li><a href="<?php echo base_url('Member/viewed-profile') // viewed-profile.html ?>">Who Viewed my Profile</a></li>
		                <li><a href="<?php echo base_url('Member/contacted') //contacted.html ?>">Contacted</a></li>
		                <li><a href="<?php echo base_url('Member/premium') //members.html ?>">Premium Members</a></li>
		                <li><a href="<?php echo base_url('Member/shortlisted') // shortlisted.html ?>">Shortlisted Profile</a></li>
		              </ul>
		            </li>
		            <li class="dropdown">
		              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Dinner<span class="caret"></span></a>
		              <ul class="dropdown-menu" role="menu">
		                <li><a href="<?php echo base_url('Member/matches') // matches.html ?>">Invitation</a></li>
		                <li><a href="<?php echo base_url('Member/viewed-profile') // viewed-profile.html ?>">Send Invitation</a></li>
		                <li><a href="<?php echo base_url('Member/contacted') //contacted.html ?>">Contacted</a></li>
		                <li><a href="<?php echo base_url('Member/premium') //members.html ?>">Premium Members</a></li>
		                <li><a href="<?php echo base_url('Member/shortlisted') // shortlisted.html ?>">Shortlisted Profile</a></li>
		              </ul>
...
<div class="banner">
  <div class="container">
    <div class="banner_info">
      <h3>Kami Menjual KEBAHAGIAAN !</h3>
      <a href="<?php echo base_url().'Gate/'?>register" class="hvr-shutter-out-horizontal"  >Daftar dan Temukan Kebahagiaan</a>
    </div>
  </div>
...
<div class="grid_1" style="background-color:#000;">
	<div class="container">
	<h1><font color="white" >Bagaimana Kami Bisa Membuat Anda Bahagia?</font> </h1>
       <div class="bg" style="margin-top: 50px; margin-bottom: 50px">
            ...
            <div class="col-sm-6">
            	<div class="bg_left">
            		<h4>Kami berniat tulus..</h4>
            		<h5>Bagi para Wanita</h5>
            		<p>"Apa yang kami lakukan di sini BUKAN untuk main-main, jika memang Anda bersungguh-sungguh mencari seorang yang pas untuk Anda, maka kami pun akan melayani dengan tulus, apapun hasilnya yang kita lakukan hanyalah berusaha biarlah Yang Maha Kuasa yang menentukan .</p>
            ...
            <div class="col-sm-6">
            	<div class="bg_left">
            		<h4>Jadilah Pilihan yang tepat</h4>
            		<h5>Bagi para pria</h5>
            		<p>"Ini bukan tempat iseng, jika Anda hanya berniat iseng silahkan hubungi mucikari Anda. Di sini adalah tempat untuk membina kesungguhan Anda sebagai seorang pria dari hati seorang wanita yang beruntung mendapatkan Anda. </p>
            	   <ul class="team-socials">
                    <li><a href="#"><span class="icon-social "><i class="fa fa-facebook"></i></span></a></li>
                    <li><a href="#"><span class="icon-social "><i class="fa fa-twitter"></i></span></a></li>
                    <li><a href="#"><span class="icon-social"><i class="fa fa-google-plus"></i></span></a></li>
      ...
      <div class="container">
      	<h1><font color="white">Temukan Pasangan Sejati Anda</font> </h1>
       	<div class="heart-divider">
			<span class="grey-line"></span>
			<i class="fa fa-heart pink-heart"></i>
			<i class="fa fa-heart grey-heart"></i>
...
<div class="grid_2">
	<div class="container" style="margin-top: 50px">
		<h2>Mereka yang telah Sukses Berbahagia</h2>
       	<div class="heart-divider">
			<span class="grey-line"></span>
			<i class="fa fa-heart pink-heart"></i>
			<i class="fa fa-heart grey-heart"></i>
	    ...
	    <div class="col-md-4 row_1-right">
	      <h3>News & Events</h3>
	        ...
	        <div class="religion">
			   ...
			   <a href="#" target="_blank" class="religion_1" title="Muslim Matrimonial" style="padding-left:0px !important;">Hindu</a>
